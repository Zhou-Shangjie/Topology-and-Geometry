...
\begin{definition}[Connection]
    ...
    A connection on $P$ is a unique seperation of the tangent space $T_u P$ into the vertical subspace $V_u P$ and the horizontal subspace $H_u P$ for any $u\in P$ such that 
    \begin{enumerate}
