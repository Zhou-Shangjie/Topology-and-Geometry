...
\begin{definition}[Fiber Bundle\label{def:fiberbundle}]
    ...
    \begin{enumerate}
        ...
        \item If $\{U_i,\phi_i\}$ and $\{\widetilde{U}_i,\widetilde{\phi}_i\}$ satisfy the above requirements, then $\{U_i\cup \widetilde{U}_i,\phi_i\cup\widetilde{\phi}_i\}$ also satisfies the above requirements.
    \end{enumerate}
\end{definition}
